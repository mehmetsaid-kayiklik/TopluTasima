...
data class RmvLogUiState(
    ...
    val fromOptionsFromCache: Boolean = false,
    val toOptionsFromCache: Boolean = false,
    val fromOptionsUpdatedAtEpochMillis: Long? = null,
    val toOptionsUpdatedAtEpochMillis: Long? = null,
    ...
    val departuresUpdatedAtEpochMillis: Long? = null,
    val selectedDeparture: Departure? = null,
    val trip: TripResult? = null,
    val tripUpdatedAtEpochMillis: Long? = null,
